...
const MealProductListing = () => {
  ...
  return <View style={styles.container}>
      <TabView tabTitles={["All", "Best Products"]} selected={selectedTab} onPress={setSelectedTab} style={styles.tabView} />
      <FlatList data={productList} keyExtractor={item => item.id.toString()} renderItem={({
      item
            ...
            <View style={styles.buttons}>
              ...
              <Pressable style={[styles.button, addedProducts.includes(item) ? null : styles.redBtn]} onPress={() => handleAddProduct(item)}>
                <Image source={addedProducts.includes(item) ? require("./assets/doubleTickIcon.png") : require("./assets/addIcon.png")} style={styles.btnIcon} />
